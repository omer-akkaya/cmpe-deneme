...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 22 May 2023, 14:51:00
...
VALUES (1, 'Cleaners', 'public/cleansers.png'),
  (2, 'Hair Care', 'public/hair-care.png'),
  (3, 'Dental Care', 'public/dental-care.jpg'),
  (4, 'Face Care', 'public/face-care.png'),
  (5, 'Vitamins', 'public/vitamins.png'),
  (6, 'Baby Care', 'public/baby-care.png');
-- --------------------------------------------------------
--
